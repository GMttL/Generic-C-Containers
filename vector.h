 ...
 * type and is appropriate for a wide variety of storage problems.  It 
 ...
 * the vector can refer to elements via (void *) pointers.
 */
 ...
 *
 * The VectorFreeFunction is the function that will be called on an element that
 ...
 * NULL for the VectorFreeFunction if the elements don't require any special handling.
 *
 ...
 * one will care.
 *
 * The initialAllocation is the your opportunity to tune the resizing
 * behavior for your particular needs.  Clients who expect their vectors to
 ...
 * will use the default value of its own choosing.  As assert is raised if 
